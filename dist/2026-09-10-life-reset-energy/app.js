(function () {
  ...
  data.choices.forEach((choice) => {
    ...
    button.innerHTML = `
      <span class="choice-art art-${choice.id.toLowerCase()}" aria-hidden="true"></span>
      <span class="choice-copy"><b>${choice.id}</b><span>${choice.label}</span></span>
  ...
  function showResult(choice, button) {
    ...
    fields.symbol.className = `result-symbol art-${choice.id.toLowerCase()}`;
